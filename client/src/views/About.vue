<template>
  <div class="about view">
    ...
    <p>
      The goal is to have enough daily participants to reach a critical mass that will produce improvements in the quality of life for mankind.
    </p>
    <p>
      ...
      This is known as the <a href="https://tmhome.com/benefits/study-maharishi-effect-group-meditation-crime-rate/" target="_blank" class="external" rel="noopener">"Maharishi effect"</a>.
    </p>
    <p>
